...
def get_token_by_token(token: str) -> None | dict:
...
def list_tokens_by_user(email: str) -> list[dict]:
...
def update_token_by_token(token: str, email: str, valid: bool) -> bool:
    try:
...
def delete_tokens_by_user(email: str) -> bool:
    try:
...
def delete_token_by_token(token: str) -> bool:
    try:
